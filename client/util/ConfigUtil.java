...
public class ConfigUtil {
    ...
    public static void loadServerConfig() {
        ...
        try {
            ...
            if (is != null) {
                ...
                // 读取服务器配置
                serverHost = props.getProperty("server.host", DEFAULT_HOST);
                ...
                System.out.println("从配置文件加载服务器配置: " + serverHost + ":" + serverPort);
                configLoaded = true;
            } else {
                System.out.println("配置文件 " + CONFIG_FILE + " 不存在，使用默认配置: " + DEFAULT_HOST + ":" + DEFAULT_PORT);
    ...
    public static void reloadServerConfig() {
        configLoaded = false;
        loadServerConfig();
        System.out.println("服务器配置已重新加载: " + serverHost + ":" + serverPort);
    }
