...
/**
 * 教师成绩管理课程卡片组件
 * 用于显示单个课程的详细信息，专门用于成绩管理功能
 */
public class TeacherGradeCard extends JPanel {
    private CourseVO course;
    private TeacherGradeCardPanel parentPanel;
    ...
    public TeacherGradeCard(CourseVO course, TeacherGradeCardPanel parentPanel, UserVO currentUser, ServerConnection connection) {
        this.course = course;
