...
public class StoreShoppingCartModule extends JPanel {
    ...
    private void initUI() {
        ...
        deleteColumn.setCellEditor(new CartButtonEditor(new JCheckBox(), controller, this, "删除", -1));
    ...
    private void checkout(ActionEvent e) {
        ...
        CheckoutDialog dialog = new CheckoutDialog(controller, currentUser, tableModel.getItems());
    ...
    private static class CartTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            switch (columnIndex) {
                ...
                case 4: return String.format("%.2f", item.getPrice() * item.getQuantity());
                case 5: return "删除";
                default: return null;
            }
        }
        ...
        public boolean isCellEditable(int rowIndex, int columnIndex) {
            return columnIndex == 3; // 只允许编辑数量列
        }

        @Override
        public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
            if (columnIndex == 3 && aValue instanceof Integer) {
                int newQuantity = (Integer) aValue;
                if (newQuantity > 0) {
                    ShoppingCartItemVO item = items.get(rowIndex);
                    try {
                        // 调用更新购物车项的服务
    ...
    // 按钮渲染器
    private static class CartButtonRenderer extends JButton implements TableCellRenderer {
    ...
    private class CartButtonEditor extends DefaultCellEditor {
        ...
        public CartButtonEditor(JCheckBox checkBox, StoreController controller, 
                               StoreShoppingCartModule cartModule, String label, int rowId) {
            super(checkBox);
            this.controller = controller;
        ...
        public Object getCellEditorValue() {
            if (isPushed) {
                JButton clickedButton = (JButton) getComponent(0);
                ...
                if ("删除".equals(buttonText)) {
                    ...
                    if (confirm == JOptionPane.YES_OPTION) {
                        try {
                            ShoppingCartItemVO item = tableModel.getItems().get(rowId);
