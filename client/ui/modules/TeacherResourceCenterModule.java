...
/** 教师版资源中心模块。 */
public class TeacherResourceCenterModule implements IModuleView {
    private JPanel root;

    public TeacherResourceCenterModule() { buildUI(); }

    private void buildUI() {
        root = new JPanel(new BorderLayout());
        root.setBorder(BorderFactory.createEmptyBorder(24, 24, 24, 24));
        JLabel placeholder = new JLabel("资源中心-教师端（开发中）", SwingConstants.CENTER);
        placeholder.setFont(new Font("Microsoft YaHei UI", Font.BOLD, 20));
        root.add(placeholder, BorderLayout.CENTER);
    }

    @Override public String getKey() { return ModuleKeys.TEACHER_RESOURCE_CENTER; }
    ...
    public static void registerTo(Class<?> ignored) { ModuleRegistry.register(new TeacherResourceCenterModule()); }
}
