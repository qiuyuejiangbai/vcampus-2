...
public class TeacherForumModule implements IModuleView {
    ...
    public TeacherForumModule() { buildUI(); }

    private void buildUI() {
        root = new JPanel(new BorderLayout());
        root.setBorder(BorderFactory.createEmptyBorder(24, 24, 24, 24));
        JLabel placeholder = new JLabel("论坛-教师端（开发中）", SwingConstants.CENTER);
        placeholder.setFont(new Font("Microsoft YaHei UI", Font.BOLD, 20));
        root.add(placeholder, BorderLayout.CENTER);
    }

    @Override public String getKey() { return ModuleKeys.TEACHER_FORUM; }
